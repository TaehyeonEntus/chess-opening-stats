      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          <Dialog open={isBoardOpen} onOpenChange={setIsBoardOpen}>
            ...
            <DialogContent className="max-w-6xl h-[100dvh] sm:h-auto sm:max-h-[95vh] overflow-hidden p-4 sm:p-6">
              <DialogHeader>
                <DialogTitle>{t("boardSearchTitle")}</DialogTitle>
                <DialogDescription>{t("boardSearchDescription")}</DialogDescription>
              </DialogHeader>

              <div className="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-6 h-full min-h-0 overflow-hidden">
                ...
                {/* Right Column: Stacked Info and Stats */}
                  ...
                  <div className="rounded-lg border bg-card p-4 shadow-sm flex flex-col justify-center min-w-0">
                    ...
                    {boardStatW ? (
                        <div className="flex items-center gap-8">
                          ...
                          <div className="flex-1 space-y-2">
                            <div className="flex gap-1 h-2.5">
                              <div className="rounded-l-sm bg-emerald-500 shadow-sm" style={{ width: `${boardStatW.winRate}%` }} />
                              <div className="bg-amber-400 shadow-sm" style={{ width: `${boardStatW.drawRate}%` }} />
                              <div className="rounded-r-sm bg-rose-500 shadow-sm" style={{ width: `${boardStatW.lossRate}%` }} />
                            </div>
                        ...
                        <div className="text-center">
                          <p className="text-xs text-muted-foreground italic">{t("noDataAvailable") || "No data"}</p>
                        </div>
                    )}
                  </div>
                  ...
                  <div className="rounded-lg border bg-card p-4 shadow-sm flex flex-col justify-center min-w-0">
                    ...
                    {boardStatB ? (
                        <div className="flex items-center gap-8">
                          ...
                          <div className="flex-1 space-y-2">
                            <div className="flex gap-1 h-2.5">
                              <div className="rounded-l-sm bg-emerald-500 shadow-sm" style={{ width: `${boardStatB.winRate}%` }} />
                              <div className="bg-amber-400 shadow-sm" style={{ width: `${boardStatB.drawRate}%` }} />
                              <div className="rounded-r-sm bg-rose-500 shadow-sm" style={{ width: `${boardStatB.lossRate}%` }} />
                            </div>
                            <div className="flex justify-between text-[11px] tabular-nums font-medium text-muted-foreground">
